...
parentdir = r'/Volumes/stor/Projects/DeepDive/5_datarelease_packages/vol1_v4_afterreview_4sb' # OSX format
...
max_MBsize = 2 # 2000 mb is the suggested threshold above which to use the large file uploader.
